	...
	public static void game(String user) {
		...
		if (user.equalsIgnoreCase(computer)) {
			...
			if (checkWin(user, computer)) {
			   print("You have defeated the most powerful being in the universe, the computer! You win!!");
			} else {
			   print("The computer crushed your soul, you lost!");
			}
		}
	}
